...
avconv -framerate 10 -loglevel quiet -start_number $Start_Number -i "${Name_Part_1}%03d${Name_Part_2}" -s:v 1920x1080 -b:v 8640k -c:v libx264 -profile:v high -crf 20 -pix_fmt yuv420p ${Output}-$Start_Number.mp4